...
function preload(){
  ...
  restartImg = loadImage("images/restart.jfif");
}
...
function draw() {
  ...
  text("Score: "+ score, 500,0);

  textAlign(CENTER, TOP);
  text("Press SPACE or UP ARROW to jump ", 0,2);
  ...
  if (gameState===PLAY){
    ...
    if(keyDown("space") && trex.y >= 159 || keyDown("UP_ARROW")) {
      trex.velocityY = -12;
    }
